...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    //Gör validering SERVER VALIDERING !!!
    ...
    //$v->field('Birthday', 'Födelsedag')->date()->date_after('1920-01-01')->date_before('2025-12-31');    
                    ...
                    <form method="post" class="form">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <span class="alert"><?php echo $v->get_error_message('Streetaddress');  ?></span>
